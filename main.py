...
print(f"Three objects I found are a {object_1}, a {object_2}, and a {object_3}.")

# Familiarize yourself with the syntax of the print() function.
# Print your name.
# Print today's date.
# Print the name of your favorite movie.
print("My name is Diego Hernandez\n I am 15 years old")
print("Today's date is August 25, 2023")
print("My favorite movie is Avengers Infinity War")
...
print(f"In 10 years, {Your_Name} will be {Age + 10} years old.")
